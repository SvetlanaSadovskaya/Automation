...
public class HW8 extends BaseTest {
    ...
    public void checkValueOn() {
        ...
        driver.findElement(By.id("c1")).sendKeys("Америка");
        driver.findElement(By.id("c2")).sendKeys("Австралия");
        // кликнуть чекбокс
        ...
        selectPart.selectByValue("Америка");
        ...
        Assert.assertEquals(driver.findElement(By.tagName("p")).getText(), "С вами свяжется наш менеджер.");
        // кликнуть на ссылку и проверить, что новая страница была открыта
        driver.findElement(By.tagName("a")).click();
        Assert.assertEquals(driver.getCurrentUrl(), "http://localhost:63342/Automation/Lecture_8/Lecture_8.html");
